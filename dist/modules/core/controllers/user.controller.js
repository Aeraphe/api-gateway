...
var user_response_1 = require("../response/user.response");
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.get = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_repository_1.default.getUser(req, res)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    UserController.prototype.getAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, user_repository_1.default.getAllUser(req, res)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
